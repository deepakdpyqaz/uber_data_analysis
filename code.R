...
jul_data <- read.csv("Uber-dataset/data/uber-raw-data-jul14.csv")
aug_data <- read.csv("Uber-dataset/data/uber-raw-data-aug14.csv")
sep_data <- read.csv("Uber-dataset/data/uber-raw-data-sep14.csv")
